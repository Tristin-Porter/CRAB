...
public class WASM : MapSet
{
    ...
    public Map<AstNode, string> CompilationUnit = TypedMap.For<string>()
        .Emit(node => {
            ...
            sb.AppendLine("    (local $result_ptr i32)");
            sb.AppendLine("    (local $result_len i32)");
            sb.AppendLine("    (local $i i32)");
            sb.AppendLine("    ;; Calculate total length");
            sb.AppendLine("    local.get $left_len");
            sb.AppendLine("    local.get $right_len");
            sb.AppendLine("    i32.add");
            sb.AppendLine("    local.set $result_len");
            sb.AppendLine("    ;; Allocate memory for result");
            sb.AppendLine("    local.get $result_len");
            sb.AppendLine("    call $alloc");
            sb.AppendLine("    local.set $result_ptr");
            sb.AppendLine("    ;; Copy left string");
            sb.AppendLine("    i32.const 0");
            sb.AppendLine("    local.set $i");
            sb.AppendLine("    (block $break_left");
            sb.AppendLine("      (loop $loop_left");
            sb.AppendLine("        ;; Check if we've copied all bytes");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        local.get $left_len");
            sb.AppendLine("        i32.ge_u");
            sb.AppendLine("        br_if $break_left");
            sb.AppendLine("        ;; Copy byte from left string");
            sb.AppendLine("        local.get $result_ptr");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.get $left_ptr");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        i32.load8_u");
            sb.AppendLine("        i32.store8");
            sb.AppendLine("        ;; Increment counter");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        i32.const 1");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.set $i");
            sb.AppendLine("        br $loop_left");
            sb.AppendLine("      )");
            sb.AppendLine("    )");
            sb.AppendLine("    ;; Copy right string");
            sb.AppendLine("    i32.const 0");
            sb.AppendLine("    local.set $i");
            sb.AppendLine("    (block $break_right");
            sb.AppendLine("      (loop $loop_right");
            sb.AppendLine("        ;; Check if we've copied all bytes");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        local.get $right_len");
            sb.AppendLine("        i32.ge_u");
            sb.AppendLine("        br_if $break_right");
            sb.AppendLine("        ;; Copy byte from right string");
            sb.AppendLine("        local.get $result_ptr");
            sb.AppendLine("        local.get $left_len");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.get $right_ptr");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        i32.load8_u");
            sb.AppendLine("        i32.store8");
            ...
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.set $i");
            sb.AppendLine("        br $loop_right");
            sb.AppendLine("      )");
            sb.AppendLine("    )");
            sb.AppendLine("    ;; Return result pointer and length");
            sb.AppendLine("    local.get $result_ptr");
            sb.AppendLine("    local.get $result_len");
            sb.AppendLine("  )");
            sb.AppendLine();
            ...
            sb.AppendLine("    (local $is_negative i32)");
            sb.AppendLine("    (local $digit_count i32)");
            sb.AppendLine("    (local $i i32)");
            sb.AppendLine("    (local $digit i32)");
            sb.AppendLine("    ;; Handle zero specially");
            sb.AppendLine("    local.get $value");
            sb.AppendLine("    i32.eqz");
            sb.AppendLine("    if");
            sb.AppendLine("      ;; Allocate 1 byte for '0'");
            sb.AppendLine("      i32.const 1");
            sb.AppendLine("      call $alloc");
            sb.AppendLine("      local.tee $result_ptr");
            sb.AppendLine("      i32.const 48  ;; ASCII '0'");
            sb.AppendLine("      i32.store8");
            sb.AppendLine("      local.get $result_ptr");
            sb.AppendLine("      i32.const 1");
            sb.AppendLine("      return");
            sb.AppendLine("    end");
            sb.AppendLine("    ;; Check if negative");
            sb.AppendLine("    local.get $value");
            sb.AppendLine("    i32.const 0");
            sb.AppendLine("    i32.lt_s");
            sb.AppendLine("    local.set $is_negative");
            sb.AppendLine("    ;; Make value positive for digit extraction");
            sb.AppendLine("    local.get $is_negative");
            sb.AppendLine("    if");
            sb.AppendLine("      i32.const 0");
            sb.AppendLine("      local.get $value");
            sb.AppendLine("      i32.sub");
            sb.AppendLine("      local.set $value");
            sb.AppendLine("    end");
            sb.AppendLine("    ;; Count digits");
            sb.AppendLine("    local.get $value");
            sb.AppendLine("    local.set $temp");
            sb.AppendLine("    i32.const 0");
            sb.AppendLine("    local.set $digit_count");
            sb.AppendLine("    (block $break_count");
            sb.AppendLine("      (loop $loop_count");
            sb.AppendLine("        ;; Increment digit count");
            sb.AppendLine("        local.get $digit_count");
            sb.AppendLine("        i32.const 1");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.set $digit_count");
            sb.AppendLine("        ;; Divide by 10");
            sb.AppendLine("        local.get $temp");
            sb.AppendLine("        i32.const 10");
            sb.AppendLine("        i32.div_u");
            sb.AppendLine("        local.tee $temp");
            sb.AppendLine("        ;; Continue if not zero");
            sb.AppendLine("        i32.eqz");
            sb.AppendLine("        br_if $break_count");
            sb.AppendLine("        br $loop_count");
            sb.AppendLine("      )");
            sb.AppendLine("    )");
            sb.AppendLine("    ;; Calculate total length (digits + minus sign if negative)");
            sb.AppendLine("    local.get $digit_count");
            sb.AppendLine("    local.get $is_negative");
            sb.AppendLine("    i32.add");
            sb.AppendLine("    local.set $result_len");
            sb.AppendLine("    ;; Allocate memory");
            sb.AppendLine("    local.get $result_len");
            sb.AppendLine("    call $alloc");
            sb.AppendLine("    local.set $result_ptr");
            sb.AppendLine("    ;; Add minus sign if negative");
            sb.AppendLine("    local.get $is_negative");
            sb.AppendLine("    if");
            sb.AppendLine("      local.get $result_ptr");
            sb.AppendLine("      i32.const 45  ;; ASCII '-'");
            sb.AppendLine("      i32.store8");
            sb.AppendLine("    end");
            sb.AppendLine("    ;; Write digits from right to left");
            sb.AppendLine("    local.get $result_len");
            sb.AppendLine("    i32.const 1");
            sb.AppendLine("    i32.sub");
            sb.AppendLine("    local.set $i");
            sb.AppendLine("    (block $break_write");
            sb.AppendLine("      (loop $loop_write");
            sb.AppendLine("        ;; Extract digit (value % 10)");
            sb.AppendLine("        local.get $value");
            sb.AppendLine("        i32.const 10");
            sb.AppendLine("        i32.rem_u");
            sb.AppendLine("        i32.const 48  ;; ASCII '0'");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.set $digit");
            sb.AppendLine("        ;; Write digit");
            sb.AppendLine("        local.get $result_ptr");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        i32.add");
            sb.AppendLine("        local.get $digit");
            sb.AppendLine("        i32.store8");
            sb.AppendLine("        ;; Divide value by 10");
            sb.AppendLine("        local.get $value");
            sb.AppendLine("        i32.const 10");
            sb.AppendLine("        i32.div_u");
            sb.AppendLine("        local.set $value");
            sb.AppendLine("        ;; Decrement i");
            sb.AppendLine("        local.get $i");
            sb.AppendLine("        i32.const 1");
            sb.AppendLine("        i32.sub");
            sb.AppendLine("        local.tee $i");
            sb.AppendLine("        ;; Check if we've written all digits (or reached minus sign)");
            sb.AppendLine("        local.get $is_negative");
            sb.AppendLine("        i32.lt_u");
            sb.AppendLine("        br_if $break_write");
            sb.AppendLine("        br $loop_write");
            sb.AppendLine("      )");
            sb.AppendLine("    )");
            sb.AppendLine("    ;; Return result pointer and length");
            sb.AppendLine("    local.get $result_ptr");
