// CRAB Test File: HelloWorld
// This file contains embedded C#, .sln, and .slnx content
// When executed with 'crab test', it generates a complete project
...
Project("{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}") = "HelloWorld", "HelloWorld.csproj", "{12345678-1234-1234-1234-123456789ABC}"
EndProject
Global
...
<Solution Version="1.0">
  ...
  <Project Path="HelloWorld.csproj" Name="HelloWorld" Type="C#" Id="{12345678-1234-1234-1234-123456789ABC}" />
</Solution>
// === END SLNX ===
